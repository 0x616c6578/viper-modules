...
class Office(Module):
    ...
    def ole_id(self, ole):
        ...
        if ole.exists("Macros"):
            has_macros = True
            db.add_tags(__sessions__.current.file.sha256, "Macros")
        ...
        for stream in ole.listdir():
            ...
            if has_flash:
                db.add_tags(__sessions__.current.file.sha256, "Flash Objects")

        # Encrypted Tag.
        if is_encrypted:
            db.add_tags(__sessions__.current.file.sha256, "Encrypted")
